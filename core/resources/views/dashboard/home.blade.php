...
@section('content')
    <div class="padding p-b-0">
        <!-- <div class="margin">
            <h5 class="m-b-0 _300" style="text-align:center; font-size:28px; color:#ff6600;">
    {{ __('backend.hi') }} 
    ...
    {{ __('backend.welcomeBack') }}
        ...
        <div style="background: linear-gradient(90deg, #2c3033ff, #583d84ff); 
            color: white; 
            padding: 30px; 
            text-align: center; 
            border-radius: 12px; 
            margin: 20px 0;">
    <h2 style="margin: 0; font-size: 32px; font-weight: 600;">
        {{ __('backend.hi') }} 
                                            ...
                                            <div class="box p-a" style="cursor: pointer"
                                                ...
                                                <a href="{{ route('topics',$headerWebmasterSection->id) }}">
                                                    <div class="pull-left m-r">
                                                        <i class="material-icons  text-2x text-{{(@$clr_ary[$ik]!="")?@$clr_ary[$ik]:"muted"}} m-y-sm">{!! $LiIcon !!}</i>
                                                    </div>
                                                    <div class="clear">
                                                        <div
